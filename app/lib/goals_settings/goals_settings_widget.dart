...
import 'goals_settings_model.dart';
export 'goals_settings_model.dart';

class GoalsSettingsWidget extends StatefulWidget {
  const GoalsSettingsWidget({Key? key}) : super(key: key);

  @override
  _GoalsSettingsWidgetState createState() => _GoalsSettingsWidgetState();
}

class _GoalsSettingsWidgetState extends State<GoalsSettingsWidget> {
  late GoalsSettingsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GoalsSettingsModel());
                                  ...
                                  child: TextFormField(
                                    controller: _model.stepGoalController ??=
                                      ...
                                      text: valueOrDefault<String>(
                                        containerGoalsRecord?.stepCount
                                            ?.toString(),
                                        '10000',
                                      ),
                                    ),
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    controller: _model.sleepHoursController ??=
                                        TextEditingController(
                                      text: valueOrDefault<String>(
                                        containerGoalsRecord?.sleepHours
                                            ?.toString(),
                                        '7',
                                      ),
                                    ),
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.exerciseMinutesController ??=
                                            TextEditingController(
                                      text: valueOrDefault<String>(
                                        containerGoalsRecord?.exerciseMinutes
                                            ?.toString(),
                                        '20',
                                      ),
                                    ),
                      ...
                      if (!(isWeb
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await queryGoalsRecordOnce(
                                singleRecord: true,
                              ).then((s) => s.firstOrNull);
                              if (containerGoalsRecord != null) {
                                await containerGoalsRecord!.reference
