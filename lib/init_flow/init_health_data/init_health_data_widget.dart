...
import 'init_health_data_model.dart';
export 'init_health_data_model.dart';

class InitHealthDataWidget extends StatefulWidget {
  const InitHealthDataWidget({Key? key}) : super(key: key);

  @override
  _InitHealthDataWidgetState createState() => _InitHealthDataWidgetState();
}

class _InitHealthDataWidgetState extends State<InitHealthDataWidget> {
  late InitHealthDataModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InitHealthDataModel());
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  12.0, 0.0, 12.0, 12.0),
                              child: Text(
                                'Input your basic health metrics such as age, gender, weight, and height for accurate health tracking.',
                                textAlign: TextAlign.start,
                            ...
                            Padding(
                              ...
                              child: Autocomplete<String>(
                                ...
                                optionsBuilder: (textEditingValue) {
                                  ...
                                  return ['Male', 'Female'].where((option) {
                                ...
                                optionsViewBuilder:
                                  ...
                                  return AutocompleteOptionsList(
                                    textFieldKey: _model.genderKey,
                                    textController: _model.genderController!,
                                ...
                                onSelected: (String selection) {
                                  setState(() =>
                                      _model.genderSelectedOption = selection);
                                  FocusScope.of(context).unfocus();
                                },
                                fieldViewBuilder: (
                                  context,
