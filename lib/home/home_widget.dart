                ...
                Padding(
                  ...
                  child: GridView(
                    ...
                    children: [
                      ...
                      StreamBuilder<List<HeartRateRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<HeartRateRecord> containerHeartRateRecordList =
                              snapshot.data!;
                          final containerHeartRateRecord =
                              containerHeartRateRecordList.isNotEmpty
                                  ? containerHeartRateRecordList.first
                                  : null;
                          return Container(
                            width: MediaQuery.sizeOf(context).width * 0.4,
                            height: 160.0,
                      ...
                      StreamBuilder<List<ActiveEnergyRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<ActiveEnergyRecord>
                              containerActiveEnergyRecordList = snapshot.data!;
                          return Container(
                            width: MediaQuery.sizeOf(context).width * 0.4,
                            height: 160.0,
                            decoration: BoxDecoration(
                      ...
                      StreamBuilder<List<ExercisesRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<ExercisesRecord> containerExercisesRecordList =
                              snapshot.data!;
                          return Container(
                            width: MediaQuery.sizeOf(context).width * 0.4,
                            height: 160.0,
